...
void C3D20::calculate_Ke(){
    ...
    Eigen::Matrix<double,3,3> invJ;
    // dim(B) = 6 x nnodes*3
    Eigen::Matrix<double,6,60> B;
    // dim(dNdxdydz) = dim(dNdXhidEtadMy) = ndim x nnodes
    Eigen::Matrix<double,3,20> dNdxdydz;
    Eigen::Matrix<double,3,20> dNdXhidEtadMy;

    // init dense Ke & Me to zero
    Ke.setZero();
    double dN1dXhi,dN2dXhi,dN3dXhi,dN4dXhi,dN5dXhi,dN6dXhi,dN7dXhi,dN8dXhi,dN9dXhi,dN10dXhi,dN11dXhi,dN12dXhi,dN13dXhi,dN14dXhi,dN15dXhi,dN16dXhi,dN17dXhi,dN18dXhi,dN19dXhi,dN20dXhi;
    double dN1dEta,dN2dEta,dN3dEta,dN4dEta,dN5dEta,dN6dEta,dN7dEta,dN8dEta,dN9dEta,dN10dEta,dN11dEta,dN12dEta,dN13dEta,dN14dEta,dN15dEta,dN16dEta,dN17dEta,dN18dEta,dN19dEta,dN20dEta;   
    double dN1dMy,dN2dMy,dN3dMy,dN4dMy,dN5dMy,dN6dMy,dN7dMy,dN8dMy,dN9dMy,dN10dMy,dN11dMy,dN12dMy,dN13dMy,dN14dMy,dN15dMy,dN16dMy,dN17dMy,dN18dMy,dN19dMy,dN20dMy;
    double w,xhi,eta,my;
    ...
    for (unsigned int i = 0; i < gauss_points->size(); i++) {
        ...
        // Eigen::JacobiSVD<Eigen::Matrix<double,3,3>> svd(J, Eigen::ComputeFullV | Eigen::ComputeFullU);
        ...
        // construct B matrix
        B << dNdxdydz(0,0),0.d,0.d,dNdxdydz(0,1),0.d,0.d,dNdxdydz(0,2),0.d,0.d,dNdxdydz(0,3),0.d,0.d,dNdxdydz(0,4),0.d,0.d,dNdxdydz(0,5),0.d,0.d,dNdxdydz(0,6),0.d,0.d,dNdxdydz(0,7),0.d,0.d,dNdxdydz(0,8),0.d,0.d,dNdxdydz(0,9),0.d,0.d,dNdxdydz(0,10),0.d,0.d,dNdxdydz(0,11),0.d,0.d,dNdxdydz(0,12),0.d,0.d,dNdxdydz(0,13),0.d,0.d,dNdxdydz(0,14),0.d,0.d,dNdxdydz(0,15),0.d,0.d,dNdxdydz(0,16),0.d,0.d,dNdxdydz(0,17),0.d,0.d,dNdxdydz(0,18),0.d,0.d,dNdxdydz(0,19),0.d,0.d,
                0.d,dNdxdydz(1,0),0.d,0.d,dNdxdydz(1,1),0.d,0.d,dNdxdydz(1,2),0.d,0.d,dNdxdydz(1,3),0.d,0.d,dNdxdydz(1,4),0.d,0.d,dNdxdydz(1,5),0.d,0.d,dNdxdydz(1,6),0.d,0.d,dNdxdydz(1,7),0.d,0.d,dNdxdydz(1,8),0.d,0.d,dNdxdydz(1,9),0.d,0.d,dNdxdydz(1,10),0.d,0.d,dNdxdydz(1,11),0.d,0.d,dNdxdydz(1,12),0.d,0.d,dNdxdydz(1,13),0.d,0.d,dNdxdydz(1,14),0.d,0.d,dNdxdydz(1,15),0.d,0.d,dNdxdydz(1,16),0.d,0.d,dNdxdydz(1,17),0.d,0.d,dNdxdydz(1,18),0.d,0.d,dNdxdydz(1,19),0.d,
                0.d,0.d,dNdxdydz(2,0),0.d,0.d,dNdxdydz(2,1),0.d,0.d,dNdxdydz(2,2),0.d,0.d,dNdxdydz(2,3),0.d,0.d,dNdxdydz(2,4),0.d,0.d,dNdxdydz(2,5),0.d,0.d,dNdxdydz(2,6),0.d,0.d,dNdxdydz(2,7),0.d,0.d,dNdxdydz(2,8),0.d,0.d,dNdxdydz(2,9),0.d,0.d,dNdxdydz(2,10),0.d,0.d,dNdxdydz(2,11),0.d,0.d,dNdxdydz(2,12),0.d,0.d,dNdxdydz(2,13),0.d,0.d,dNdxdydz(2,14),0.d,0.d,dNdxdydz(2,15),0.d,0.d,dNdxdydz(2,16),0.d,0.d,dNdxdydz(2,17),0.d,0.d,dNdxdydz(2,18),0.d,0.d,dNdxdydz(2,19),
                dNdxdydz(1,0),dNdxdydz(0,0),0.d,dNdxdydz(1,1),dNdxdydz(0,1),0.d,dNdxdydz(1,2),dNdxdydz(0,2),0.d,dNdxdydz(1,3),dNdxdydz(0,3),0.d,dNdxdydz(1,4),dNdxdydz(0,4),0.d,dNdxdydz(1,5),dNdxdydz(0,5),0.d,dNdxdydz(1,6),dNdxdydz(0,6),0.d,dNdxdydz(1,7),dNdxdydz(0,7),0.d,dNdxdydz(1,8),dNdxdydz(0,8),0.d,dNdxdydz(1,9),dNdxdydz(0,9),0.d,dNdxdydz(1,10),dNdxdydz(0,10),0.d,dNdxdydz(1,11),dNdxdydz(0,11),0.d,dNdxdydz(1,12),dNdxdydz(0,12),0.d,dNdxdydz(1,13),dNdxdydz(0,13),0.d,dNdxdydz(1,14),dNdxdydz(0,14),0.d,dNdxdydz(1,15),dNdxdydz(0,15),0.d,dNdxdydz(1,16),dNdxdydz(0,16),0.d,dNdxdydz(1,17),dNdxdydz(0,17),0.d,dNdxdydz(1,18),dNdxdydz(0,18),0.d,dNdxdydz(1,19),dNdxdydz(0,19),0.d,
                0.d,dNdxdydz(2,0),dNdxdydz(1,0),0.d,dNdxdydz(2,1),dNdxdydz(1,1),0.d,dNdxdydz(2,2),dNdxdydz(1,2),0.d,dNdxdydz(2,3),dNdxdydz(1,3),0.d,dNdxdydz(2,4),dNdxdydz(1,4),0.d,dNdxdydz(2,5),dNdxdydz(1,5),0.d,dNdxdydz(2,6),dNdxdydz(1,6),0.d,dNdxdydz(2,7),dNdxdydz(1,7),0.d,dNdxdydz(2,8),dNdxdydz(1,8),0.d,dNdxdydz(2,9),dNdxdydz(1,9),0.d,dNdxdydz(2,10),dNdxdydz(1,10),0.d,dNdxdydz(2,11),dNdxdydz(1,11),0.d,dNdxdydz(2,12),dNdxdydz(1,12),0.d,dNdxdydz(2,13),dNdxdydz(1,13),0.d,dNdxdydz(2,14),dNdxdydz(1,14),0.d,dNdxdydz(2,15),dNdxdydz(1,15),0.d,dNdxdydz(2,16),dNdxdydz(1,16),0.d,dNdxdydz(2,17),dNdxdydz(1,17),0.d,dNdxdydz(2,18),dNdxdydz(1,18),0.d,dNdxdydz(2,19),dNdxdydz(1,19),
                dNdxdydz(2,0),0.d,dNdxdydz(0,0),dNdxdydz(2,1),0.d,dNdxdydz(0,1),dNdxdydz(2,2),0.d,dNdxdydz(0,2),dNdxdydz(2,3),0.d,dNdxdydz(0,3),dNdxdydz(2,4),0.d,dNdxdydz(0,4),dNdxdydz(2,5),0.d,dNdxdydz(0,5),dNdxdydz(2,6),0.d,dNdxdydz(0,6),dNdxdydz(2,7),0.d,dNdxdydz(0,7),dNdxdydz(2,8),0.d,dNdxdydz(0,8),dNdxdydz(2,9),0.d,dNdxdydz(0,9),dNdxdydz(2,10),0.d,dNdxdydz(0,10),dNdxdydz(2,11),0.d,dNdxdydz(0,11),dNdxdydz(2,12),0.d,dNdxdydz(0,12),dNdxdydz(2,13),0.d,dNdxdydz(0,13),dNdxdydz(2,14),0.d,dNdxdydz(0,14),dNdxdydz(2,15),0.d,dNdxdydz(0,15),dNdxdydz(2,16),0.d,dNdxdydz(0,16),dNdxdydz(2,17),0.d,dNdxdydz(0,17),dNdxdydz(2,18),0.d,dNdxdydz(0,18),dNdxdydz(2,19),0.d,dNdxdydz(0,19);
...
void C3D20::calculate_Me(){
    ...
    Eigen::Matrix<double,3,60> N;
    double N1,N2,N3,N4,N5,N6,N7,N8,N9,N10,N11,N12,N13,N14,N15,N16,N17,N18,N19,N20;
    double xhi,eta,my,w;
    for (unsigned int i = 0; i < gauss_points->size(); i++) {
        xhi     = gauss_points->at(i).at(0);
        eta     = gauss_points->at(i).at(1);
        ...
        N << N1,0.d,0.d,N2,0.d,0.d,N3,0.d,0.d,N4,0.d,0.d,N5,0.d,0.d,N6,0.d,0.d,N7,0.d,0.d,N8,0.d,0.d,N9,0.d,0.d,N10,0.d,0.d,N11,0.d,0.d,N12,0.d,0.d,N13,0.d,0.d,N14,0.d,0.d,N15,0.d,0.d,N16,0.d,0.d,N17,0.d,0.d,N18,0.d,0.d,N19,0.d,0.d,N20,0.d,0.d,
             0.d,N1,0.d,0.d,N2,0.d,0.d,N3,0.d,0.d,N4,0.d,0.d,N5,0.d,0.d,N6,0.d,0.d,N7,0.d,0.d,N8,0.d,0.d,N9,0.d,0.d,N10,0.d,0.d,N11,0.d,0.d,N12,0.d,0.d,N13,0.d,0.d,N14,0.d,0.d,N15,0.d,0.d,N16,0.d,0.d,N17,0.d,0.d,N18,0.d,0.d,N19,0.d,0.d,N20,0.d,
             0.d,0.d,N1,0.d,0.d,N2,0.d,0.d,N3,0.d,0.d,N4,0.d,0.d,N5,0.d,0.d,N6,0.d,0.d,N7,0.d,0.d,N8,0.d,0.d,N9,0.d,0.d,N10,0.d,0.d,N11,0.d,0.d,N12,0.d,0.d,N13,0.d,0.d,N14,0.d,0.d,N15,0.d,0.d,N16,0.d,0.d,N17,0.d,0.d,N18,0.d,0.d,N19,0.d,0.d,N20;  
