...
C3D20::C3D20(unsigned int id, std::vector<std::shared_ptr<Node>> connectivity,std::shared_ptr<Pid> pid):id(id),connectivity(connectivity),pid(pid){
    ...
    // need to reshuffle the incoming coordnates by hand a little bit, due to different node numbering between Felipe
    // and Abaqus. This is easier for now then to figure out the changes in shape functions....
    // node 1 -> 12 are the same
    ...
    for (unsigned int i = 0; i < ngp; i++) {
                ...
                w = gauss_weights.at(gauss_point_counter);
                gauss_point_counter++;
                // std::cout << "w=" << w << ": "<< xhi << "," << eta << "," << my << std::endl;
                ...
                // std::cout << "detJ=" << J.determinant()<< std::endl;
                ...
                dNdxdydz = invJ*dNdXhidEtadMy;
                // std::cout << "dNdxdydz=" << dNdxdydz <<" ];" << std::endl;
                // construct B matrix
                B << dNdxdydz(0,0),0,0,dNdxdydz(0,1),0,0,dNdxdydz(0,2),0,0,dNdxdydz(0,3),0,0,dNdxdydz(0,4),0,0,dNdxdydz(0,5),0,0,dNdxdydz(0,6),0,0,dNdxdydz(0,7),0,0,dNdxdydz(0,8),0,0,dNdxdydz(0,9),0,0,dNdxdydz(0,10),0,0,dNdxdydz(0,11),0,0,dNdxdydz(0,12),0,0,dNdxdydz(0,13),0,0,dNdxdydz(0,14),0,0,dNdxdydz(0,15),0,0,dNdxdydz(0,16),0,0,dNdxdydz(0,17),0,0,dNdxdydz(0,18),0,0,dNdxdydz(0,19),0,0,
                    0,dNdxdydz(1,0),0,0,dNdxdydz(1,1),0,0,dNdxdydz(1,2),0,0,dNdxdydz(1,3),0,0,dNdxdydz(1,4),0,0,dNdxdydz(1,5),0,0,dNdxdydz(1,6),0,0,dNdxdydz(1,7),0,0,dNdxdydz(1,8),0,0,dNdxdydz(1,9),0,0,dNdxdydz(1,10),0,0,dNdxdydz(1,11),0,0,dNdxdydz(1,12),0,0,dNdxdydz(1,13),0,0,dNdxdydz(1,14),0,0,dNdxdydz(1,15),0,0,dNdxdydz(1,16),0,0,dNdxdydz(1,17),0,0,dNdxdydz(1,18),0,0,dNdxdydz(1,19),0,
                    0,0,dNdxdydz(2,0),0,0,dNdxdydz(2,1),0,0,dNdxdydz(2,2),0,0,dNdxdydz(2,3),0,0,dNdxdydz(2,4),0,0,dNdxdydz(2,5),0,0,dNdxdydz(2,6),0,0,dNdxdydz(2,7),0,0,dNdxdydz(2,8),0,0,dNdxdydz(2,9),0,0,dNdxdydz(2,10),0,0,dNdxdydz(2,11),0,0,dNdxdydz(2,12),0,0,dNdxdydz(2,13),0,0,dNdxdydz(2,14),0,0,dNdxdydz(2,15),0,0,dNdxdydz(2,16),0,0,dNdxdydz(2,17),0,0,dNdxdydz(2,18),0,0,dNdxdydz(2,19),
                    dNdxdydz(1,0),dNdxdydz(0,0),0,dNdxdydz(1,1),dNdxdydz(0,1),0,dNdxdydz(1,2),dNdxdydz(0,2),0,dNdxdydz(1,3),dNdxdydz(0,3),0,dNdxdydz(1,4),dNdxdydz(0,4),0,dNdxdydz(1,5),dNdxdydz(0,5),0,dNdxdydz(1,6),dNdxdydz(0,6),0,dNdxdydz(1,7),dNdxdydz(0,7),0,dNdxdydz(1,8),dNdxdydz(0,8),0,dNdxdydz(1,9),dNdxdydz(0,9),0,dNdxdydz(1,10),dNdxdydz(0,10),0,dNdxdydz(1,11),dNdxdydz(0,11),0,dNdxdydz(1,12),dNdxdydz(0,12),0,dNdxdydz(1,13),dNdxdydz(0,13),0,dNdxdydz(1,14),dNdxdydz(0,14),0,dNdxdydz(1,15),dNdxdydz(0,15),0,dNdxdydz(1,16),dNdxdydz(0,16),0,dNdxdydz(1,17),dNdxdydz(0,17),0,dNdxdydz(1,18),dNdxdydz(0,18),0,dNdxdydz(1,19),dNdxdydz(0,19),0,
                    0,dNdxdydz(2,0),dNdxdydz(0,0),0,dNdxdydz(2,1),dNdxdydz(0,1),0,dNdxdydz(2,2),dNdxdydz(0,2),0,dNdxdydz(2,3),dNdxdydz(0,3),0,dNdxdydz(2,4),dNdxdydz(0,4),0,dNdxdydz(2,5),dNdxdydz(0,5),0,dNdxdydz(2,6),dNdxdydz(0,6),0,dNdxdydz(2,7),dNdxdydz(0,7),0,dNdxdydz(2,8),dNdxdydz(0,8),0,dNdxdydz(2,9),dNdxdydz(0,9),0,dNdxdydz(2,10),dNdxdydz(0,10),0,dNdxdydz(2,11),dNdxdydz(0,11),0,dNdxdydz(2,12),dNdxdydz(0,12),0,dNdxdydz(2,13),dNdxdydz(0,13),0,dNdxdydz(2,14),dNdxdydz(0,14),0,dNdxdydz(2,15),dNdxdydz(0,15),0,dNdxdydz(2,16),dNdxdydz(0,16),0,dNdxdydz(2,17),dNdxdydz(0,17),0,dNdxdydz(2,18),dNdxdydz(0,18),0,dNdxdydz(2,19),dNdxdydz(0,19),
                    dNdxdydz(2,0),0,dNdxdydz(0,0),dNdxdydz(2,1),0,dNdxdydz(0,1),dNdxdydz(2,2),0,dNdxdydz(0,2),dNdxdydz(2,3),0,dNdxdydz(0,3),dNdxdydz(2,4),0,dNdxdydz(0,4),dNdxdydz(2,5),0,dNdxdydz(0,5),dNdxdydz(2,6),0,dNdxdydz(0,6),dNdxdydz(2,7),0,dNdxdydz(0,7),dNdxdydz(2,8),0,dNdxdydz(0,8),dNdxdydz(2,9),0,dNdxdydz(0,9),dNdxdydz(2,10),0,dNdxdydz(0,10),dNdxdydz(2,11),0,dNdxdydz(0,11),dNdxdydz(2,12),0,dNdxdydz(0,12),dNdxdydz(2,13),0,dNdxdydz(0,13),dNdxdydz(2,14),0,dNdxdydz(0,14),dNdxdydz(2,15),0,dNdxdydz(0,15),dNdxdydz(2,16),0,dNdxdydz(0,16),dNdxdydz(2,17),0,dNdxdydz(0,17),dNdxdydz(2,18),0,dNdxdydz(0,18),dNdxdydz(2,19),0,dNdxdydz(0,19);
                // compute Gauss point contribution to element Ke matrix
                // § 8.5. The Mass Matrix, chapter 8
                global_N_matrix << N1,0,0,N2,0,0,N3,0,0,N4,0,0,N5,0,0,N6,0,0,N7,0,0,N8,0,0,N9,0,0,N10,0,0,N11,0,0,N12,0,0,N13,0,0,N14,0,0,N15,0,0,N16,0,0,N17,0,0,N18,0,0,N19,0,0,N20,0,0,
                                    0,N1,0,0,N2,0,0,N3,0,0,N4,0,0,N5,0,0,N6,0,0,N7,0,0,N8,0,0,N9,0,0,N10,0,0,N11,0,0,N12,0,0,N13,0,0,N14,0,0,N15,0,0,N16,0,0,N17,0,0,N18,0,0,N19,0,0,N20,0,
                                    0,0,N1,0,0,N2,0,0,N3,0,0,N4,0,0,N5,0,0,N6,0,0,N7,0,0,N8,0,0,N9,0,0,N10,0,0,N11,0,0,N12,0,0,N13,0,0,N14,0,0,N15,0,0,N16,0,0,N17,0,0,N18,0,0,N19,0,0,N20;  
